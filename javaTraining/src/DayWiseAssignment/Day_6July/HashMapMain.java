 ...
 *
 * Complete demonstration of every public method available on java.util.HashMap,
 * plus the Collections utility methods and Map idioms commonly used with it.
 *
 * IMPORTANT NOTE ON HashMap:
 * - HashMap stores Key-Value pairs (Map.Entry<K, V>). It does NOT implement Collection directly.
 * - HashMap has NO guaranteed order for its keys, values, or entries.
 * - Keys must be UNIQUE. Adding a duplicate key overwrites the old value and returns it.
 * - Values can be DUPLICATED.
 * - It allows ONE null key and MULTIPLE null values.
 * - HashMap has no index-based lookups (like get(int)). Lookups are performed via the key.
...
public class HashMapMain {
	...
	public static void main(String[] args) {
        ...
        HashMap<String, Integer> mapCap = new HashMap<>(32);                         // initial capacity
        HashMap<String, Integer> mapCapLoad = new HashMap<>(32, 0.5f);               // capacity + load factor
        
        Map<String, Integer> initialData = Map.of("X", 10, "Y", 20, "Z", 30);
        HashMap<String, Integer> mapFromMap = new HashMap<>(initialData);            // from existing Map
        ...
        // putIfAbsent(K, V) - Only adds if key doesn't exist or is mapped to null (Java 8+)
        ...
        // remove(Object key, Object value) - Conditional removal, returns boolean (Java 8+)
        ...
        // 5.5 ADVANCED COMPUTE / MERGE IDIOMS (Java 8+)
        ...
        System.out.println("\n-- Iterating via entrySet() [Key + Value Pairs] --");
        for (Map.Entry<String, Integer> entry : map.entrySet()) {
            System.out.println(" - " + entry.getKey() + " => " + entry.getValue());
        }

        System.out.println("-- Iterating via keySet() [Keys only] --");
        Set<String> keys = map.keySet();
        for (String key : keys) {
            System.out.println(" - Key: " + key);
        }

        System.out.println("-- Iterating via values() [Values only] --");
        ...
        System.out.println("-- forEach(BiConsumer) - Java 8+ --");
        ...
        HashMap<String, Integer> cloned = (HashMap<String, Integer>) map.clone(); // clone()
        System.out.println("\nclone(): " + cloned);
        ...
        // 9. CLEARING
        HashMap<String, Integer> toClear = new HashMap<>(map);
        toClear.clear();                                // clear()
